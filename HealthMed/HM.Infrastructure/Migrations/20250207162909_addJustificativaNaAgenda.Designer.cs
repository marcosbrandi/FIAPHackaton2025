...
namespace HM.Infrastructure.Migrations
{
    ...
    [Migration("20250207162909_addJustificativaNaAgenda")]
    partial class addJustificativaNaAgenda
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HM.Domain.Entities.Agenda", b =>
                {
                    ...
                    b.Property<TimeOnly>("FimConsulta")
                        .HasColumnType("time");

                    b.Property<TimeOnly>("InicioConsulta")
                        .HasColumnType("time");
